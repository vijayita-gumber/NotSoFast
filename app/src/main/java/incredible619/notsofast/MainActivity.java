            ...
            if (currentPerson != null) {
               ...
               // mStatus.setText(name);
                ...
                if (checkAccountsPermission()) {
                  ...
                  //  mStatus.setText(currentAccount);
                   // if (currentAccount.endsWith("@iiitd.ac.in")) {
                       // Toast.makeText(this, "Registered with IIITD email account", Toast.LENGTH_LONG).show();
               ...
               // mStatus.setText("Error in Configuration..");
            }
